...
//  {
//	return getPixel(mask,
//					*sprite.getTexture(),
//					static_cast<int>(sv.x) + subRect.left,
//					static_cast<int>(sv.y) + subRect.top) > alphaLimit;
//  }
//  return false;
//}
//
...
//	  {
//
//		if (getPixel(mask1, *sprite1.getTexture(), (int)(s1v.x) + s1SubRect.left, (int)(s1v.y) + s1SubRect.top)
//			> alphaLimit &&
//			getPixel(mask2, *sprite2.getTexture(), (int)(s2v.x) + s2SubRect.left, (int)(s2v.y) + s2SubRect.top)
//				> alphaLimit)
//		  return true;
//
//	  }
...
//											  {OBB1.points[1].x - OBB1.points[0].x,
